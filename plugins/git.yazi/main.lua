...
--local neon_purple = "\27[38;2;255;0;255m"
--local reset = "\27[0m"
--
--local signs = {
    --[CODES.unknown]   = neon_purple .. "󰎤 " .. reset,   -- glitch / estrela distorcida
    --[CODES.ignored]   = neon_purple .. "󰅟 " .. reset,   -- olho cortado (vigilância)
    --[CODES.untracked] = neon_purple .. "󰞉 " .. reset,   -- cifrão / circuito
    --[CODES.modified]  = neon_purple .. "󰜋 " .. reset,   -- raio / modificação
    --[CODES.added]     = neon_purple .. "󰐗 " .. reset,   -- adição neon
    --[CODES.deleted]   = neon_purple .. "󰅖 " .. reset,   -- cruz / deletado
    --[CODES.updated]   = neon_purple .. "󰜋 " .. reset,   -- mesmo que modified
    --[CODES.clean]     = neon_purple .. "󰄲 " .. reset,   -- check minimalista
--}
...
local signs = {
		...
		[CODES.deleted] = t.deleted_sign or "󰅖",
